...
sudo pacman -S --noconfirm i3-gaps picom conky xorg-xrdb xorg-xrandr i3status-manjaro rxvt-unicode neovim tmux chromium ttf-dejavu ttf-dejavu-sans-mono-powerline zsh zsh-autosuggestions zsh-syntax-highlighting wqy-microhei gtkmm3
